...
export function Inspector() {
  ...
  const handleRollback = () => {
      // Rollback logic currently mocks by just updating modified/notes
      // Real rollback needs to update `content` store.
      // For now, we just close dialog. To be implemented fully in DP-Next.
      ...
      <Tabs defaultValue="general" className="flex-1 flex flex-col min-h-0">
        ...
        <ScrollArea className="flex-1">
           ...
           <TabsContent value="general" className="m-0 p-4 space-y-6">
            ...
            {/* Tab: Synopsis */}
            <TabsContent value="synopsis" className="m-0 p-4 space-y-6">
           ...
           {/* Tab: Notes */}
           <TabsContent value="notes" className="m-0 h-full flex flex-col p-4">
           ...
           {/* Tab: Snapshots */}
           <TabsContent value="snapshots" className="m-0 p-4 space-y-4">
